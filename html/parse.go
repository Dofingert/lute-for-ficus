...
import (
	...
	a "github.com/Dofingert/lute-for-ficus/html/atom"
)
...
func ParseFragmentWithOptions(r io.Reader, context *Node, opts ...ParseOption) ([]*Node, error) {
	...
	if context != nil {
		...
		if context.DataAtom != a.Lookup([]byte(context.Data)) {
			return nil, errors.New("html: inconsistent Node: DataAtom=" + strconv.Itoa(int(context.DataAtom)) + ", Data=" + context.Data)
		}
